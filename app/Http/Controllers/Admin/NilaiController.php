            ...
            if ($request->ajax()) {
                ...
                foreach ($data as $index => $v_data) {
                    ...
                    if ($userAcess['is_update'] == '1') {
                        $buttonUpdate = '
                        <a href="' . route('admin.nilai.edit', $v_data->id) . '" class="btn btn-outline-warning m-b-xs btn-edit" style="border-color: #f5af47ea !important;">
                    ...
                    if ($userAcess['is_delete'] == '1') {
                        $buttonDelete = '
                        <form action=' . route('admin.nilai.destroy', $v_data->id) . ' class="d-inline">
