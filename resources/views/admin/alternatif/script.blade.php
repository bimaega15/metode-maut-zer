<script>
    $(document).ready(function(e) {
        var table = $('#dataTable').DataTable({
            ajax: {
                url: "{{ route('admin.alternatif.index') }}",
                dataType: 'json',
                type: 'get',
            },
        });
        ...
        $(document).on('click', '.btn-edit', function(e) {
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    $('.id').val(result.id);
                    $('.nama_alternatif').val(result.nama_alternatif);
                    $('.nip_alternatif').val(result.nip_alternatif);
                    $('.email_alternatif').val(result.email_alternatif);
                    $('.alamat_alternatif').val(result.alamat_alternatif);
                    $('.nohp_alternatif').val(result.nohp_alternatif);
                    $('.jenis_kelamin_alternatif[value="' + result
                        .jenis_kelamin_alternatif + '"]').attr('checked', true);
                    let linkGambar =
                        `${root}/storage/upload/alternatif/${result.gambar_alternatif}`;
                    $('#load_gambar_alternatif').html(`
                    <a class="photoviewer" href="${linkGambar}" data-gallery="photoviewer" data-title="${result.gambar_alternatif}">
