<script>
    $(document).ready(function(e) {
        var table = $('#dataTable').DataTable({
            ajax: {
                url: "{{ route('admin.kriteria.index') }}",
                dataType: 'json',
                type: 'get',
            },
        });
        ...
        function autoGenerateNumber() {
            $.ajax({
                url: `{{ url('/admin/kriteria/autoNumber') }}`,
                method: 'get',
                dataType: 'json',
        ...
        $(document).on('click', '.btn-edit', function(e) {
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    $('.id').val(result.id);
                    $('.kode_kriteria').val(result.kode_kriteria);
                    $('.nama_kriteria').val(result.nama_kriteria);
                    $('.definisi_kriteria').val(result.definisi_kriteria);
                    $('.bobot_kriteria').val(result.bobot_kriteria);
